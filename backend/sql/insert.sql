...
VALUES
(20, 'Jón', 'trainer', 'jon@example.org', '$2b$10$85bqEyXkxGgCO1XYh1zYPOI6sCYELvvyj3WHCBJT1g0JZrA1fNTla', false);

INSERT INTO clients
(id, name, email, pin, userId)
VALUES
(20, 'Sigga', 'sigga@example.org', 3453, 20);

INSERT INTO clients
(id, name, email, pin, userId)
VALUES
(21, 'Tester', 'tester@testing.com', 2352, 20);

INSERT INTO program
(id, userId, clientId, name)
VALUES
(20, 20, 20, 'Testing Program 1');

INSERT INTO program
(id, userId, clientId, name)
VALUES
(21, 20, 21, 'Testing Program 2');
